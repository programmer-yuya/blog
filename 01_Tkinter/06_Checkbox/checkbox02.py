...
# チェックボックスの作成
checkbox01 = tk.Checkbutton(root, text="選択肢１", variable=state_checkbox01)
checkbox01.pack()
checkbox02 = tk.Checkbutton(root, text="選択肢２", variable=state_checkbox02)
checkbox02.pack()
checkbox03 = tk.Checkbutton(root, text="選択肢３", variable=state_checkbox03)
checkbox03.pack()
